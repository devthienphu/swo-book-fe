...
export const loginOptions = createContext();
const Login = () => {
    const [login,setLogin]=useState(false);
    // pt-12 pb-3 px-32 gap-y-12
    return (
        <>
            <div style={{ 
            ...
            >   
                <div className="relative flex justify-center items-center flex-col flex-wrap gap-y-2 p-4">
                    <div className="bg-white relative flex flex-col flex-wrap justify-center items-center rounded-lg gap-y-12 pb-3 pt-8 md:pt-12 md:px-32 px-8">
                        ...
                        {/* Backbutton */}
                        {
                            (login)?<button className="absolute items-left left-0 top-0 p-8" onClick={()=>{setLogin(!login)}}>
                        ...
                        <NavLink to="/">
                            ...
                            <p className="font-black text-3xl">Đăng nhập vào F8</p>
                        </div>

                        {/* login options */}
                        {
                            (login)?<AccountLogin/>:<Options state={login} setState={setLogin}/>
                        }
                        {/* forgot password */}
                        ...
                        <div className="flex flex-col items-center flex-wrap gap-x-1">
                            <div className="flex flex-row flex-wrap items-center justify-center gap-x-1">
                                ...
                                <NavLink to="/register" className="text-orange-600 font-semibold">Đăng ký</NavLink>
                            </div>

                            {
                                (login)?<NavLink to="/forgot-password" className="text-orange-600 font-semibold">Quên mật khẩu</NavLink>:null
                            }
