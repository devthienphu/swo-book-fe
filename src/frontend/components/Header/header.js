        ...
        <div className="z-100 flex flex-row justify-between fixed top-0 w-full right-0 left-0 p-3 border-b-2 bg-white z-20">
            ...
            <form className="flex items-center hidden md:flex">   
                ...
                <div className="relative w-full">
                    ...
                    <input type="text" id="simple-search" className="bg-white border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-gray-900 focus:border-blue-500 block w-full pl-10 p-2.5 mr-48" placeholder="Tìm kiếm khóa học, bài viết, video..." required=""/>
                </div>
            </form>
            ...
            <div className="flex items-center">
                <p className="text-gray-800 font-semibold text-md px-4 hidden lg:flex">Khóa học của tôi</p>
