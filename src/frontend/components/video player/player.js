        ...
        <div className="w-full relative bg-black mt-12">
            ...
            <div className="relative pt-[56.25%] overflow-hidden my-2 rounded-sm">
                <iframe className="absolute top-0 left-0 right-0" frameborder="0" allowFullScreen="1"  width="100%" 
                    ...
                    src={(step)?`https://www.youtube.com/embed/${step.video_url}?autoplay=1&mute=0&controls=1&origin=https%3A%2F%2Ffullstack.edu.vn&playsinline=1&showinfo=0&rel=0&iv_load_policy=3&modestbranding=1&enablejsapi=1&widgetid=1`
                    :defautLink}></iframe>
            </div>
            </div>
        </div>
